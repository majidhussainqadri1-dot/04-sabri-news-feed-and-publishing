...
# Plugin release is 2.0.3; the Future18 feature contract itself remains 2.0.0.
check('Version: 2.0.3' in main and "SNFLA_VERSION', '2.0.3'" in main, 'Runtime must be promoted to second-audit patch 2.0.3.', fail)
...
check("VERSION='2.0.3'" in build and 'FUTURE18_COUNT=18' in build, 'Deterministic release builder must identify v2.0.3 and 18 enhancements.', fail)
...
print('Future18 source checks passed: 18/18 capabilities, ownership boundaries, safety invariants, v2.0.3 second-audit wiring, traceability and deterministic-release integration.')
