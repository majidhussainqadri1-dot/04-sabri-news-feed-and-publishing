...
round1=report('Central-plan Review/Fix Round 1 — requirements, ownership and File 04 plan traceability',[
    ('Version: 2.0.1' in main, 'Runtime must be hardened patch 2.0.1.'),
...
round2=report('Central-plan Review/Fix Round 2 — fresh adversarial/source regression',[
    ...
    ("VERSION='2.0.1'" in build and 'central_plan_review_rounds' in build and 'TEN_ROUND_REVIEW_ROUNDS=10' in build, 'Deterministic package generator must identify v2.0.1 and all review evidence.'),
...
print('Two consecutive post-plan source reviews passed with v2.0.1 hardening and zero known blockers in the tested source scope.')
