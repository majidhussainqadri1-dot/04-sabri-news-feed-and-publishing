...
require('Version: 2.0.3' in main and "SNFLA_VERSION', '2.0.3'" in main and "SNFLA_SCHEMA_VERSION', '1.3.0'" in main, 'Runtime/header must be second-audit hardened 2.0.3 while unchanged storage schema remains 1.3.0.')
...
if errors:
    ...
    sys.exit(1)
print(f'Architecture and ownership checks passed across {len(PHP)} PHP files, including v2.0.3 second-audit hardening.')
