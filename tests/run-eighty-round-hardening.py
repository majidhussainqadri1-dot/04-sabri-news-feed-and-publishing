...
need('Stable tag: 2.0.5' in t('readme.txt') and 'v2.0.5' in t('README.md') and 'v2.0.5' in status, 'R65 human current release metadata must identify v2.0.5', f)
...
if f:
    ...
    sys.exit(1)
print('Historical first 80-round guardrails remain present under the strengthened v2.0.5 source.')
