...
need('Version: 2.0.7' in main and "SNFLA_VERSION', '2.0.7'" in main,'Current runtime must be v2.0.7.',fail)
...
need("VERSION='2.0.7'" in build and 'SECOND_TEN_ROUND_REVIEW_ROUNDS=10' in build,'Builder must bind v2.0.7 and second-ten-round evidence.',fail)
