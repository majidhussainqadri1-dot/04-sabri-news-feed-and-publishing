...
need('Version: 2.0.7' in main and "SNFLA_VERSION', '2.0.7'" in main,'v2.0.7 runtime metadata missing',f)
...
need("VERSION='2.0.7'" in build and 'THIRD_TEN_ROUND_REVIEW_ROUNDS=10' in build,'Round9 builder metadata missing',f)
