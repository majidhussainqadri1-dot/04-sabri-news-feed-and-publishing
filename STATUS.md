...
`exact_head_automated_qa=pending-current-branch-run`
...
| Automated-QA Green | **Pending current correction-head workflow result** | Historical gates + second-eighty gate + 20-check cross-file gate + PHP 8.1/8.3 + secret/PII scan |
