...
final class SNFLA_Admin {
	...
	public static function page() {
		if ( ! current_user_can( 'sabri_feed_run_migrations' ) && ! current_user_can( SNFLA_Capabilities::CAP_REVIEW ) ) {
			wp_die( esc_html__( 'You are not authorized to review File 04 migration evidence.', SNFLA_TEXT_DOMAIN ), '', array( 'response' => 403 ) );
		}
		global $wpdb;
